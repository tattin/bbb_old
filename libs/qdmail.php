...
//  var $detect_order       = "iso-2022-jp,eucJP-win,UTF-8,SJIS-win,jis,ASCII";
  ...
  var $deco_def   =array(
    ...
    // TODO : iPhone 追加 ここから
    array(
      'OPTION_NAME' => array( 'ISB' , 'ISOFTBANK' ),
      'STRUCTURE'   => 4,
      '_CHARSET'    => 'Shift_JIS',
      'ENC_TEXT'    => '8bit',
      'ENC_HTML'    => 'QUOTED-PRINTABLE',
...
*/
  ...
  function qd_convert_encoding( $word , $target_chrset , $org_charset = null ){
    ...
    // TODO : sjis-win対応 ここから
    if($target_chrset == 'Shift_JIS'){
      $target_chrset = 'sjis-win';
    }
    if($org_charset == 'Shift_JIS'){
      $target_chrset = 'sjis-win';
    }
    if(strtoupper( $target_chrset ) === strtoupper( $org_charset )){
      return $word;
    }
    // TODO : sjis-win対応 ここまで
 "mb_convert_encoding( $word , $target_chrset , $org_charset );<br>";
...
/*
    $id = 'Qdmail.' . $this->version 
        ...
        . '@' . $right ;
*/
    $id = sha1( microtime() . $this->salt . mt_rand() . $req_uri )
        . '@' . $right ;
    return '<'.$id.'>';
  }
